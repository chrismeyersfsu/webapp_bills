...
function instantiateBook(book, anchor) {
    ...
    <div class="ui-grid-b"> \
        ...
        <div class="ui-block-b" style="width: auto"> \
            <input type="button" id="'+usedRentId+'" data-icon="plus" data-inline="true" style="padding-top: 1px"';
            if (book.availUsedRent == "N/A") {
                str += ' ' + strDisabled;
            }
    str += ' value="Rent Used $'+book.priceUsedRent+'" /><br \> \
            <input type="button" id="'+newRentId+'" data-icon="plus" data-inline="true"';
            if (book.availNewRent == "N/A") {
                str += ' ' + strDisabled;
            }
    str += ' value="Rent New $'+book.priceNewRent+'" /></div> \
        <div class="ui-block-c" style="width: auto"> \
            <input type="button" id="'+usedId+'" data-icon="plus" data-inline="true"';
            if (book.availUsed == "N/A") {
                str += ' ' + strDisabled;
            }
    str += ' value="Used $'+book.priceUsed+'" /><br \> \
            <input type="button" id="'+newId+'" data-icon="plus" data-inline="true"';
            if (book.availNew == "N/A") {
                str += ' ' + strDisabled;
            }
    str += ' value="New $'+book.priceNew+'" /></div> \
    </div> \
    </li>';
...
function catchKartClick(event) {
    ...
    var iconE = $('#'+itemId).parent().find("span.ui-icon");
    var disableIconE = $('#'+disableId).parent().find("span.ui-icon");
    var itemE = $('#'+itemId);
